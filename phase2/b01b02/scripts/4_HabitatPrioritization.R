...
conservationCriteriaList<-data.frame(Name=c("habitatSuitability", "betweennessLong", "betweennessShortBTSL", "dECGapBTSL", "dECNatalBTSL", "currentFlowBTSL"),
                                    FileName=c(paste0("habitatSuitability_", myResolution, "m.tif"), "betweenness.tif", "betweenness_BTSL.tif", "dECGap_BTSL.tif", "dECNatal_BTSL.tif", "30_FULL_curmap_BTSL.tif"),
